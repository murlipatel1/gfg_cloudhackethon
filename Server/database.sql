...
INSERT INTO expenditure (user_id, Loan_id, Ifsc_code, Loan_amount, Card_balance, Credit_score, Stock_name, Stock_price, Total_Stock_price)
VALUES 
    (1, 'L001', 'ABC123', 10000.00, 5000.00, 750, 'AAPL', 200.00, 400.00),
    (2, 'L002', 'DEF456', 15000.00, 8000.00, 650, 'GOOG', 300.00, 900.00),
    (1, 'L003', 'GHI789', 20000.00, 10000.00, 800, 'MSFT', 150.00, 300.00),
    (3, 'L004', 'JKL012', 12000.00, 6000.00, 700, 'TSLA', 250.00, 750.00),
    (2, 'L005', 'MNO345', 18000.00, 9000.00, 600, 'AMZN', 400.00, 1600.00);
	
INSERT INTO finance_planning (Bike_amount, Car_amount, Home_amount, Loan_with_interest)
VALUES 
